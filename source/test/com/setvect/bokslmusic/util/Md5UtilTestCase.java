...
public class Md5UtilTestCase {
	@Rule
	public ErrorCollector collection = new ErrorCollector();
	...
	public void testMd5Check() throws NoSuchAlgorithmException, IOException {
		...
		collection.checkThat(md5Str, is("81721b89ce1f183b38ea04201c6821fa"));

		md5Str = Md5Util.getMD5Checksum(file, 0, 163840);
		collection.checkThat(md5Str, is("3f0511a0c3eef50b898a4ed132cbd8d3"));

		file = new File("sample_data/notfound.aaaa");
		md5Str = Md5Util.getMD5Checksum(file);
		collection.checkThat(null, nullValue());
